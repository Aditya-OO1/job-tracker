    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-light text-sm">Sign in to your job tracker</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-light mt-6">
          No account?{' '}
          <Link to="/register" className="text-accent-bright hover:text-white transition-colors font-medium">
            Create one free
          </Link>
        </p>
      </div>
